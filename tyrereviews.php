           ...
           <div class="dropdown">
            ...
            <div class="row" style="min-height:500px;">
                ...
                <div class="col-sm-6">
                    ...
                    <p>
                        <span style="font-weight:bold">Note:</span> The post was created from the content submitted by firmgriptyre consumer
                        surveys. The information displayed is the true opinion of the consumer and meant to be used
                ...
                if($link = new mysqli($host, $user, $password, $database)){
                    ...
                    <div id="<?php echo $row['review_id']; ?>" style="border-bottom:2px solid #666;margin-bottom:10px;">
                        <div class="row" style="background:#ccc">
                            <div class="col-sm-8">
                                <h5 style="font-weight:bold">Consumer Review of <?php echo $row['tyrebrand']; ?></h5>
                            </div>
                            
                            <div class="col-sm-4">
                                <h5>
                           <?php
                                                    switch ($row['descision']){
                                                        case "definitely not":
                            ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                               <p>
                                   Kilometers Driven on Tyres: 
                                   <span style="font-weight:bold;">
                                       <?php echo $row['kmcoverage']; ?>
                                   </span>
                               </p> 
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                               <p>
                                   Initial Review: 
                                   <span style="font-weight:bold;">
                                       <?php echo $row['kmcoverage']; ?> Kilometers on Tyres
                                   </span>
                               </p>  
                            </div>
                        </div> 
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                               <p>
                                   ...
                                   <span style="font-weight:bold;">
                                       <?php echo date('F d,Y',$row['review_id']); ?>
                                   </span>
                               </p>  
                            </div>
                        </div>
