            ...
            <div class="row">
                <div class="col-sm-2" id="navigate" style="background:#000;padding:30px 0px;">
                    <ul class="nav nav-pills nav-stacked" id="menu">
                        ...
                        <li class="active"><a href="deletesub.php"><span class="fa fa-user-times"></span> Delete Subscribers</a></li>
...
?>
                    ...
                    <input type="button" value="Delete Subscription" id="deleteButton"  />
                </div>
...
function remove(){
	...
	xmlhttp.onreadystatechange = function(){
								...
								document.getElementById("tableCon").innerHTML = xmlhttp.responseText;
								}//end if		
		}
		...
		if(v>=1){
			if(confirm('Are You sure You want To Delete?')){
				...
				xmlhttp.open('POST','subdelete.php',true);// open the file
