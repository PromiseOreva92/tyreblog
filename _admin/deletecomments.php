            ...
            <div class="row">
                <div class="col-sm-2" id="navigate" style="background:#000;padding:30px 0px;">
                    <ul class="nav nav-pills nav-stacked" id="menu">
                        ...
                        <li><a href="deletecomments.php"><span class="fa fa-commenting"></span> View Comments</a></li>
                        <li class="active"><a href="deletecomments.php"><span class="fa fa-times-circle-o"></span> Delete Comments</a></li>
...
?>
                    ...
                    <input type="button" value="delete Comments" id="deleteButton"  /> 
                </div>
	...
	xmlhttp.onreadystatechange = function(){
		...
		if(v>=1){
			if(confirm('Are You sure You want To Delete?')){
				...
				xmlhttp.open('POST','commentdelete.php',true);// open the file
